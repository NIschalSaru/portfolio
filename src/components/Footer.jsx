export default function Footer() {
  return (
    <footer className="border-t border-border-light bg-canvas font-mono">
      <div className="max-w-[1100px] mx-auto px-5 py-8 flex flex-col md:flex-row items-center justify-between gap-4">
        <div className="text-[13px] text-ink-secondary">
          ...
          <span className="text-ink-muted">:~$</span>
          <span className="text-ink ml-1">exit</span>
        </div>
        <p className="text-[12px] text-ink-muted">
          <span className="text-ink-muted">#</span> © {new Date().getFullYear()} Nischal Saru
        </p>
