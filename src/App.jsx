...
export default function App() {
  return (
    <div className="min-h-screen bg-dark-900">
      ...
      <Footer />
      <div className="pointer-events-none sticky bottom-0 ml-auto mr-14 sm:mr-20 -mt-[50vh] h-[50vh] w-max hidden flex-col items-center gap-4 z-40 md:flex">
        <div className="flex items-center">
          <span className="text-[11px] font-mono text-ink-muted [writing-mode:vertical-rl] leading-none">
            nischalsaru.official@gmail.com
          </span>
        </div>
